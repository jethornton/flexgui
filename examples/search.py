...
def extract_button_names(file_path):
	...
	'pocket_prepped_lb', 'position_lb', 'probe_tripped_lb', 'probe_val_lb',
	'probed_position_lb', 'probing_lb', 'program_units_lb', 'queue_lb',
	'queue_full_lb', 'rapid_override_lb', 'rapidrate_lb', 'read_line_lb',
	'rotation_xy_lb', 'spindle_lb', 'spindles_lb', 'state_lb', 'task_mode_lb',
	'task_paused_lb', 'task_state_lb', 'tool_in_spindle_lb',
	'tool_from_pocket_lb', 'tool_offset_lb', 'tool_table_lb']
